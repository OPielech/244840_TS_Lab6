    ...
    <section class="hotels" >
      <div class="container">
        <header>
          ...
          <p>Chcesz spędzić niezapomniane wakacje? Sprawdź nasz najnowszy ranking hoteli i wybierz ten, który idealnie spełni
            wszystkie Twoje wymagania!</p>

          <div class="p2">
            <p>
              Ranking tworzymy na podstawie własnych doświadczeń ale także na podstawie waszych opnii. Każdą z&nbsp;nich
              dokładnie czytamy i&nbsp;weryfikujemy. Robimy to po to aby zapobiec rozczarowaniom i&nbsp;zapewnić naszym użytkownikom
